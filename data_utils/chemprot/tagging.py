...
from data_utils.chemprot.preprocessing import replace_ponctuation_with_space, tokenize_sentence, process
from nltk.tokenize import word_tokenize

LABELSET = {'CHEMICAL': {'b': 'B-CHEMICAL', 'i': 'I-CHEMICAL', 'l': 'L-CHEMICAL', 'u': 'U-CHEMICAL'},
             'GENE-Y': {'b': 'B-GENE-Y', 'i': 'I-GENE-Y', 'l': 'L-GENE-Y', 'u': 'U-GENE-Y'},
            'GENE-N': {'b': 'B-GENE-N', 'i': 'I-GENE-N', 'l': 'L-GENE-N', 'u': 'U-GENE-N'}}
